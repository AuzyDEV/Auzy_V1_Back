...
const { addDB, deleteDB, updateDB, getAllDB, getOneDBWithFileDetails, getAllDBWithSpecificAttribute, getAllDBNameAndId } = require("./listing-directory-controller");
const router = express.Router();
router.post("/addDB", addDB)
router.put("/updateDB/:id", updateDB)
router.get("/DB/:collectionName", getAllDB)
router.get("/DBB/:collectionName", getAllDBNameAndId)
